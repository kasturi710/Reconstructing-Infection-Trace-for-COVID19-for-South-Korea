...
path = os.path.join('CONDOR', 'ERp_loop', 'res')
...
for f in onlyfiles:
    ...
    #print fullname
    ERp_range, correct_found_seeds, cost_ratio, correct_interaction_recall, correct_interaction_precision, \
...
plt.plot(ERp_range, np.nanmean(arr_correct_found_seeds, axis=0))
plt.xlabel('ER p')
...
plt.xlabel('ER p')
plt.plot(ERp_range, np.nanmean(arr_cost_ratio, axis=0))
plt.xlabel('ER p')
#plt.show()
...
plt.plot(ERp_range, np.nanmean(arr_correct_interaction_recall, axis=0))
plt.plot(ERp_range, np.nanmean(arr_correct_interaction_precision, axis=0))
plt.plot(ERp_range, np.nanmean(arr_correct_causality_recall, axis=0))
plt.plot(ERp_range, np.nanmean(arr_correct_causality_precision, axis=0))
plt.plot(ERp_range, np.nanmean(arr_total_order_tau, axis=0))
...
plt.plot(ERp_range, np.nanmean(arr_prec_out, axis=0), 'k-')
plt.plot(ERp_range, np.nanmean(arr_prec_lb, axis=0), 'k--')
plt.plot(ERp_range, np.nanmean(arr_prec_ub, axis=0), 'k:')
plt.plot(ERp_range, np.nanmean(arr_recall_out, axis=0), 'r-')
plt.plot(ERp_range, np.nanmean(arr_recall_lb, axis=0), 'r--')
plt.plot(ERp_range, np.nanmean(arr_recall_ub, axis=0), 'r:')
...
plt.plot(ERp_range, np.nanmean(arr_prec_out_05, axis=0), 'k-')
plt.plot(ERp_range, np.nanmean(arr_prec_lb_05, axis=0), 'k--')
plt.plot(ERp_range, np.nanmean(arr_prec_ub_05, axis=0), 'k:')
plt.plot(ERp_range, np.nanmean(arr_recall_out_05, axis=0), 'r-')
plt.plot(ERp_range, np.nanmean(arr_recall_lb_05, axis=0), 'r--')
plt.plot(ERp_range, np.nanmean(arr_recall_ub_05, axis=0), 'r:')
...
plt.plot(ERp_range, np.nanmean(arr_F_out, axis=0))
plt.plot(ERp_range, np.nanmean(arr_F_lb, axis=0))
plt.plot(ERp_range, np.nanmean(arr_F_ub, axis=0))
...
plt.plot(ERp_range, np.nanmean(arr_correct_causality_F, axis=0))
plt.plot(ERp_range, np.nanmean(arr_ub_correct_causality_F, axis=0))
plt.plot(ERp_range, np.nanmean(arr_correct_interaction_F, axis=0))
plt.plot(ERp_range, np.nanmean(arr_ub_correct_interaction_F, axis=0))
...
plt.plot(ERp_range, np.nanmean(arr_mcc_out, axis=0))
plt.plot(ERp_range, np.nanmean(arr_mcc_lb, axis=0))
plt.plot(ERp_range, np.nanmean(arr_mcc_ub, axis=0))
