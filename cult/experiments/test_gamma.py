...
noise = 100
shift = 100
gamma_range = np.linspace(1.8, 6.0, 20)
#gamma_range = [1.8]

for gamma in gamma_range:
    print gamma
    TS, G, infection_order, infection_track, seeds, nodes = get_noisy_TS_leaves_with_P(type = dataset, n = N, inf_fraction = 0.5, seeds_num = K, noise = noise, reportP = 1.0, model = model, parameter = gamma)
    K = len(seeds)
...
pickle.dump([gamma_range, correct_found_seeds, cost_ratio, correct_interaction_recall, correct_interaction_precision,
...
plt.plot(gamma_range, correct_found_seeds)
...
plt.xlabel('shift length')
plt.plot(gamma_range, cost_ratio)
plt.xlabel('shift length')
#plt.show()
...
plt.plot(gamma_range, correct_interaction_recall)
plt.plot(gamma_range, correct_interaction_precision)
plt.plot(gamma_range, correct_causality_recall)
plt.plot(gamma_range, correct_causality_precision)
plt.plot(gamma_range, total_order_tau)
...
plt.plot(gamma_range, mean_slack)
...
plt.plot(gamma_range, prec_out, 'k-')
plt.plot(gamma_range, prec_lb, 'k--')
plt.plot(gamma_range, prec_ub, 'k:')
plt.plot(gamma_range, recall_out, 'r-')
plt.plot(gamma_range, recall_lb, 'r--')
plt.plot(gamma_range, recall_ub, 'r:')
...
plt.plot(gamma_range, prec_out_05, 'k-')
plt.plot(gamma_range, prec_lb_05, 'k--')
plt.plot(gamma_range, prec_ub_05, 'k:')
plt.plot(gamma_range, recall_out_05, 'r-')
plt.plot(gamma_range, recall_lb_05, 'r--')
plt.plot(gamma_range, recall_ub_05, 'r:')
...
plt.plot(gamma_range, F_out)
plt.plot(gamma_range, F_lb)
plt.plot(gamma_range, F_ub)
...
plt.plot(gamma_range, correct_causality_F)
plt.plot(gamma_range, ub_correct_causality_F)
plt.plot(gamma_range, correct_interaction_F)
plt.plot(gamma_range, ub_correct_interaction_F)
...
plt.plot(gamma_range, mcc_out)
plt.plot(gamma_range, mcc_lb)
plt.plot(gamma_range, mcc_ub)
