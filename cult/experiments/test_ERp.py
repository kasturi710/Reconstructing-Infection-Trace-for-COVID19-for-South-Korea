...
noise = 100
shift = 100
ERp_range = np.arange(0.1, 1.1, 0.1)
ERp_range = [0.3]

for ERp in ERp_range:
    TS, G, infection_order, infection_track, seeds, nodes = get_noisy_TS_leaves_with_P(type = dataset, n = N, inf_fraction = 0.5, seeds_num = K, noise = noise, reportP = 1.0, model = model, parameter = ERp)
    K = len(seeds)
    ...
    print ub_causality_recall, ub_causality_precision, ub_correct_causality_F
    exit()
...
pickle.dump([ERp_range, correct_found_seeds, cost_ratio, correct_interaction_recall, correct_interaction_precision,
...
plt.plot(ERp_range, correct_found_seeds)
...
plt.plot(ERp_range, correct_interaction_recall)
plt.plot(ERp_range, correct_interaction_precision)
plt.plot(ERp_range, correct_causality_recall)
plt.plot(ERp_range, correct_causality_precision)
plt.plot(ERp_range, total_order_tau)
...
plt.plot(ERp_range, prec_out, 'k-')
plt.plot(ERp_range, prec_lb, 'k--')
plt.plot(ERp_range, prec_ub, 'k:')
plt.plot(ERp_range, recall_out, 'r-')
plt.plot(ERp_range, recall_lb, 'r--')
plt.plot(ERp_range, recall_ub, 'r:')
...
plt.plot(ERp_range, prec_out_05, 'k-')
plt.plot(ERp_range, prec_lb_05, 'k--')
plt.plot(ERp_range, prec_ub_05, 'k:')
plt.plot(ERp_range, recall_out_05, 'r-')
plt.plot(ERp_range, recall_lb_05, 'r--')
plt.plot(ERp_range, recall_ub_05, 'r:')
...
plt.plot(ERp_range, F_out)
plt.plot(ERp_range, F_lb)
plt.plot(ERp_range, F_ub)
...
plt.plot(ERp_range, correct_causality_F)
plt.plot(ERp_range, ub_correct_causality_F)
plt.plot(ERp_range, correct_interaction_F)
plt.plot(ERp_range, ub_correct_interaction_F)
...
plt.plot(ERp_range, mcc_out)
plt.plot(ERp_range, mcc_lb)
plt.plot(ERp_range, mcc_ub)
