...
correct_found_seeds = []
noise = 100
TS, G, infection_order, infection_track, seeds, nodes = get_noisy_TS_empty_reports(type = dataset, n = N, inf_fraction = 0.5, seeds_num = K, noise = noise, model = model, parameter = parameter)
shift_range = range(1, len(TS), len(TS)/100)
#shift_range = [1,2,3]
for shift in shift_range:
    TS, G, infection_order, infection_track, seeds, nodes = get_noisy_TS_empty_reports(type = dataset, n = N, inf_fraction = 0.5, seeds_num = K, noise = noise, model = model, parameter = parameter)
    K = len(seeds)
    sources, immuned, sinks, reported, unreported, sources_TnI, sinks_TnI, unreported_TnI = get_sinks_and_sources_shifted(TS, G = nx.Graph(), mode = 'all', dt_sec = shift, rep_prob = reportingP, to_be_reported = to_be_reported)
...
pickle.dump([shift_range, correct_found_seeds, cost_ratio, correct_interaction_recall, correct_interaction_precision,
...
plt.plot(shift_range, correct_found_seeds)
...
plt.xlabel('shift length')
plt.plot(shift_range, cost_ratio)
plt.xlabel('shift length')
#plt.show()
...
plt.plot(shift_range, correct_interaction_recall)
plt.plot(shift_range, correct_interaction_precision)
plt.plot(shift_range, correct_causality_recall)
plt.plot(shift_range, correct_causality_precision)
plt.plot(shift_range, total_order_tau)
...
plt.plot(shift_range, mean_slack)
...
plt.plot(shift_range, prec_out, 'k-')
plt.plot(shift_range, prec_lb, 'k--')
plt.plot(shift_range, prec_ub, 'k:')
plt.plot(shift_range, recall_out, 'r-')
plt.plot(shift_range, recall_lb, 'r--')
plt.plot(shift_range, recall_ub, 'r:')
...
plt.plot(shift_range, prec_out_05, 'k-')
plt.plot(shift_range, prec_lb_05, 'k--')
plt.plot(shift_range, prec_ub_05, 'k:')
plt.plot(shift_range, recall_out_05, 'r-')
plt.plot(shift_range, recall_lb_05, 'r--')
plt.plot(shift_range, recall_ub_05, 'r:')
...
plt.plot(shift_range, F_out)
plt.plot(shift_range, F_lb)
plt.plot(shift_range, F_ub)
...
plt.plot(shift_range, correct_causality_F)
plt.plot(shift_range, ub_correct_causality_F)
plt.plot(shift_range, correct_interaction_F)
plt.plot(shift_range, ub_correct_interaction_F)
...
plt.plot(shift_range, mcc_out)
plt.plot(shift_range, mcc_lb)
plt.plot(shift_range, mcc_ub)
